...
Normalized effort level selected for this session. A fresh resumed handle may leave it undefined because the bridge currently returns only the session ID.
