...
Web App declares skills and tools
  ↓
Desktop Core generates agent-facing tool artifacts
  ↓
...
The application does not host `tools.md` or tool-spec files. Core generates the artifacts the agent needs inside the session sandbox.
