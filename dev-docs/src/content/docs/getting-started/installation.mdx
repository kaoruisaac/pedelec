...
Download `pedelec-integration-guideline.zip` from the [GitHub Releases page](https://github.com/kaoruisaac/pedelec/releases), extract it, and tell the Coding Agent to read `START_HERE.md`. This is a developer integration path, not a runtime prerequisite or an installer for the Pedelec Desktop App or Chrome Extension.
