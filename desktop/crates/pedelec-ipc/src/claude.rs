...
mod tests {
    use super::*;
    use pedelec_core::{
        error_codes, CreateThreadInput, CreateThreadSkillsInput, EffortLevel, EndThreadInput,
        OpenWorkspaceInput, PersistentRuntimeOperation, PrepareThreadInput, SendTextInput,
